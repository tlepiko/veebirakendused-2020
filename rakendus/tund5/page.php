	...
	if(count($photoList)>0) {
		do {
			...
			if(in_array($photoNum2, $photoRandomNum) == false) {
				...
				$randomImageHTML .= '<div style="float:left; width:33.33%; padding:5px; box-sizing:border-box;"><img src="' .$picsDir .$photoList[$photoNum2] .'" width=100% alt="juhuslik pilt Haapsalust"></div>' ."\n";
			}
